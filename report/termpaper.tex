...
\caption{Graphene can be envisioned in several dimensions. 0-dimensional buckyballs, 1-dimensional nanotubes, or 3-dimensional graphite (Taken from \cite{nanoscaleReview2011}, originally found in \cite{Novoselov2007}.)}
\label{fig:sp2}
\end{figure}
