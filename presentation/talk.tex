...
%------------------------------------------------
\section{The Emergence of Graphene} 
%------------------------------------------------
\begin{frame}
\frametitle{Origins of Graphene}
Just testing.
\end{frame}

\section{Transition Metal Dichalcogenides}
\subsection{Properties of \ch{MoS2}}

\section{Synthesis of \ch{MoS2} using mechanical exfoliation methods}

\section{Applications of \ch{MoS2}}
